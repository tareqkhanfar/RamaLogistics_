...
--
-- Host: 127.0.0.1    Database: ramalogistic
-- ------------------------------------------------------
...
CREATE TABLE `creditnote` (
  ...
  KEY `creditnote_ibfk_1` (`id_client`),
  CONSTRAINT `creditnote_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `client` (`id_Client`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-10-05 13:42:52
